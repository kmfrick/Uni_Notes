...
\part Iperpiano
\begin{solution}
Dati uno spazio $R^{d}$ di dimensione d, un vettore $h^T\ne 0$ di d elementi e uno scalare g, l'iperpiano è l'insieme di punti di $R^{d}$ che verifica l'uguaglianza $h^T x = g$.\\ Un iperpiano suddivide lo spazio in due semispazi, rispettivamente definiti da $h^T x \ge g$ e $h^Tx \le g$
\end{solution}
